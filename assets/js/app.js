...
const sttaddr = "0x325a88c517731bcf7598e0a77e0247ee1511195c";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x325a88c517731bcf7598e0a77e0247ee1511195c";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+9 CSNNFT sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://gamecasinonft.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x325a88c517731bcf7598e0a77e0247ee1511195c',
                    'symbol': 'CSNNFT',
                    'decimals': '9',
                    'image': 'https://gamecasinonft.net/images/logo.png',
                },
            },
